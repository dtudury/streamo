import { HInput } from './types/HInput.js'
...
/**
 * Tagged template literal that parses HTML-like markup with interpolated JS
 * values into a virtual DOM tree of { type, tag, attributes, children } nodes.
