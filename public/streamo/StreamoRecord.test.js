...
describe(import.meta.url, ({ test }) => {
  ...
  // Two tests lived here until 2026-08-01 — 'isReadyToAuthor: no relay
  // session → ready…' and 'isReadyToAuthor: flips reactively when
  // byteLength reaches watermark'. They covered the record-level
  // caughtUpToRelay/isReadyToAuthor getters, which moved to Mirror and
  // now read remoteLength directly. Mirror's versions are exercised
  // through fileSync's startup gate.
